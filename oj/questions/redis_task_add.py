...
def add_task(user_id, question_id, code, test_args, expected_output,lang,status):

        temp={"question":question_id, "code":code ,"test_args":test_args ,"expected_output":expected_output,"lang":lang,"status":status}
